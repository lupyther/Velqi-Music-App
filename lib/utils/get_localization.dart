...
Map<String, Map<String, String>> get keys => {
  "ar" : {
    ...
    "loudnessNormalizationDes": "تعيين نفس مستوى شدة الصوت لجميع الأغاني (تجريبي) (لن يعمل على الأغاني التي تم تحميلها في النسخ السابقة (< V1.0.0))",
    ...
    "content": "Съдържание",
    "loudnessNormalizationDes": "Задава едно и също ниво на силата на звука за всички песни (Експериментално) (Няма да работи с песни, изтеглени на предишна версия (< V1.0.0))",
    ...
    "loudnessNormalizationDes": "Estableix la mateixa longitud de soroll per a totes les cançons (Experimental) (no funcionarà en les cançons descarregades en la versió anterior(< V1.0.0))",
    "misc": "Miscel·lània",
    ...
    "loudnessNormalizationDes": "Nastaví stejnou úroveň hlasitosti pro všechny skladby (Experimentální) (Nebude fungovat u skladeb stažených v předchozí verzi(< V1.0.0))",
    ...
    "loudnessNormalizationDes": "Stellt für alle Titel die gleiche Lautstärke ein (experimentell) (Funktioniert nicht bei Titeln, die mit einer früheren Version (< V1.0.0) heruntergeladen wurden)",
    ...
    "loudnessNormalizationDes": "Sets same lavel of loudness for all songs (Experimental) (Will not work on songs downloaded on previous version(< V1.0.0))",
    ...
    "loudnessNormalizationDes": "Establece el mismo nivel de volumen para todas las canciones (Experimental) (No funcionará en canciones descargadas en versiones anteriores (< V1.0.0))",
    ...
    "loudnessNormalizationDes": "Seadista kõikidele esitatavatele lugudele sama helivaljus (katseline funktsionaalsus). (See ei toimi rakenduse varasema versiooniga allalaaditud lugude puhul (< V1.0.0))",
    ...
    "loudnessNormalizationDes": "سطح صدای یکسانی را برای همه آهنگ ها تنظیم می کند (تجربی) (روی آهنگ های دانلود شده در نسخه های قبلی کار نمی کند (قبل از V1.0.0))",
    ...
    "loudnessNormalizationDes": "I-ayon sa pantay na lebel ng lakas ang mga kanta (eksperimental) (Hindi gagana sa mga kantang na-download sa nakaraang bersyon(<V1.0.0))",
    ...
    "loudnessNormalizationDes": "Définit le même niveau de volume pour tous les titres (expérimental) (Cela ne fonctionnera pas sur les titres téléchargés sur la version précédente (< V1.0.0))",
    "id": "Identifiant",
    ...
    "content": "Contido",
    "loudnessNormalizationDes": "Establece o mesmo nivel de volume para todas as cancións (Experimental) (Non funcionará coas cancións descargadas na versión anterior (< V1.0.0))",
    ...
    "loudnessNormalizationDes": "सभी गानों के लिए समान स्तर की ध्वनि निर्धारित करता है (प्रायोगिक) (पिछले संस्करण (< V1.0.0) पर डाउनलोड किए गए गानों पर काम नहीं करेगा)",
    ...
    "loudnessNormalizationDes": "Define le mesme nivello de volumine pro tote le cantos (Experimental) (Non functionara con le cantos discargate sur le versiones previe (< V1.0.0))",
    ...
    "backup": "Cadangan",
    "loudnessNormalizationDes": "Atur level kekerasan suara yang sama untuk semua lagu (Eksperimental) (Tidak akan berfungsi pada lagu yang diunduh di versi sebelumnya (< V1.0.0))",
    ...
    "loudnessNormalizationDes": "Imposta lo stesso livello di loudness per tutti i brani (sperimentale) (non funziona con i brani scaricati con la versione precedente (< V1.0.0))",
    ...
    "loudnessNormalizationDes": "ਸਾਰੇ ਗੀਤਾਂ (ਪ੍ਰਯੋਗਾਤਮਕ) ਲਈ ਉੱਚੀ ਆਵਾਜ਼ ਦਾ ਇੱਕੋ ਪੱਧਰ ਸੈੱਟ ਕਰਦਾ ਹੈ (ਪਿਛਲੇ ਸੰਸਕਰਣ (< V1.0.0) 'ਤੇ ਡਾਊਨਲੋਡ ਕੀਤੇ ਗੀਤਾਂ 'ਤੇ ਕੰਮ ਨਹੀਂ ਕਰੇਗਾ)",
    ...
    "loudnessNormalizationDes": "Ustawia ten sam poziom głośności dla wszystkich utworów (eksperymentalne) (nie działa z utworami pobranymi w poprzedniej wersji (< V1.0.0))",
    "title": "Tytuł",
    "id": "Id",
    ...
    "loudnessNormalizationDes": "Define o mesmo volume para todas as músicas (Experimental) (Não funcionará em músicas baixadas antes da versão (< V1.0.0))",
    ...
    "loudnessNormalizationDes": "Setează același volum pentru toate melodiile (Experimental) (Nu o să funcționeze pentru melodiile descărcate pe versiuni anterioare(< V1.0.0))",
    ...
    "loudnessNormalizationDes": "Nastaví rovnakú úroveň hlasitosti pre všetky skladby (Experimentálne) (Nebude fungovať na skladbách stiahnutých v predchádzajúcej verzii(< V1.0.0))",
    ...
    "loudnessNormalizationDes": "Поставља исти ниво гласноће за све песме (експериментално) (Неће радити на песмама преузетим у претходној верзији (< V1.0.0))",
    ...
    "loudnessNormalizationDes": "எல்லா பாடல்களுக்கும் ஒரே அளவிலான சத்தத்தை அமைக்கிறது (சோதனை) (முந்தைய பதிப்பில் பதிவிறக்கம் செய்யப்பட்ட பாடல்களில் (<V1.0.0) வேலை செய்யாது)",
    ...
    "loudnessNormalizationDes": "అన్ని పాటలకు (ప్రయోగాత్మకం) ఒకే రకమైన శబ్దాన్ని సెట్ చేస్తుంది (మునుపటి వెర్షన్‌లో డౌన్‌లోడ్ చేసిన పాటలపై పని చేయదు(< V1.0.0))",
    ...
    "loudnessNormalizationDes": "Tüm şarkılar için aynı ses yüksekliği seviyesini ayarlar (Deneysel) (Önceki sürümde (< V1.0.0) indirilen şarkılarda çalışmaz)",
    ...
    "loudnessNormalizationDes": "Встановлює однаковий рівень гучності для всіх пісень (експериментальний) (не працюватиме для пісень, завантажених у попередній версії (< V1.0.0))",
    ...
    "loudnessNormalizationDes": "Cài đặt cùng một mức độ lớn cho tất cả bài hát (Thử nghiệm) (Không hoạt động đối với các bài hát đã tải về trong phiên bản trước (< V1.0.0))",
    ...
    "loudnessNormalizationDes": "为所有歌曲设置相同的音量（实验性）（不适用于以前版本（<V1.0.0）下载的歌曲）",
    ...
    "loudnessNormalizationDes": "將所有歌曲調整成相同的音量（實驗性功能，不適用於在舊版本（< V1.0.0）下載的歌曲）",
